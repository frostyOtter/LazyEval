...
class Settings(BaseSettings):
    ...
    MODEL_BASE_URL: str = Field(..., description="Base URL for the OpenAI-compatible API")
    ...
    LANGFUSE_BASE_URL: str = Field(default="https://cloud.langfuse.com", description="Langfuse base URL")
